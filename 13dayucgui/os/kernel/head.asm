...
#下面这种跳转在实际的硬件中是有问题的，不知为何
  //pushl $0x300000
  //retl
  jmp  $(2*8), $0x280000
    c513:	ea 00 00 28 00 10 00 	ljmp   $0x10,$0x280000
...
0000c52c <gdt>:
    ...
    c541:	9a c7 00 ff ff 00 00 	lcall  $0x0,$0xffff00c7
    c548:	30 9a 47 00 00 00    	xor    %bl,0x47(%edx)
...
00000000 <.stabstr>:
   ...
   6:	63 63 50             	arpl   %sp,0x50(%ebx)
   9:	6f                   	outsl  %ds:(%esi),(%dx)
   a:	6b 6d 46 64          	imul   $0x64,0x46(%ebp),%ebp
